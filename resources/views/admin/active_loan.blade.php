      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-tools">
            <a  type="button" id="loan_create" class="btn btn-info float-left" href="{{route('loan.request')}}" class="nav-link"> <i class="fas fa-coin"></i> Loan Requests</a>
                ...
                @foreach($activeloans as $loan)
                  <tr>
                      ...
                      <td class="project-state">
                       ...
                       <td>
                          {{$loan->active==1?\Carbon\Carbon::parse($loan->loanPayment()->due_date)->format('Y-m-d'):''}}
                      </td>
                      <?php 
                      ...
                      <td class="project_progress">
                          ...
                          <small>
                            {{$status}} day(s) till expiration 
                          </small>
                      </td>
                      <td class="project-actions text-right">
                          <a class="btn btn-danger btn-sm" href="{{route('loan.deactivate',['id'=>$loan->id])}}">
                              <i class="fas fa-ban">
                              </i>
                              Deactivate
                          </a>
